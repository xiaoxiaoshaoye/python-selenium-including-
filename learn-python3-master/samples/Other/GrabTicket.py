          ...
          try:
            ...
            # self.driver.reload()
              ...
              for user in self.users:
                    ...
                    self.driver.find_by_id('').select(self.pz)#成人票
                    # sleep(1)
                    self.driver.find_by_text(self.xb).click()#二等座
                    sleep(1)
                    self.driver.find_by_id('submitOrder_id').click()#提交订单按钮
                    print (u"开始选座...")
                    self.driver.find_by_id('1D').last.click()
                    self.driver.find_by_id('1F').last.click()
                    sleep(1.5)
                    print (u"确认选座信息...")
                    self.driver.find_by_id('qr_submit_id').click()#最后确认信息按钮
          except Exception as e:
                     print (e)
